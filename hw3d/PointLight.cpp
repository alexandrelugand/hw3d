...
namespace Entities
{
	...
	void PointLight::SpawnControlWindow() noexcept
	{
		if (ImGui::Begin("Light"))
		{
			...
			ImGui::SliderFloat("Linear", &cbData.attLin, 0.0001f, 2.0f, "%.4lf", ImGuiSliderFlags_NoRoundToFormat);
			ImGui::SliderFloat("Quadratic", &cbData.attQuad, 0.0000001f, 0.06f, "%.7lf", ImGuiSliderFlags_NoRoundToFormat);
